...
export default async function handler(req, res) {
    if(req.method == "POST"){
        ...
        let { name, desciprtion, privacy, password } = req.body;
        ...
        if(room_with_same_name){
            ...
            let room_doc = { _type:"room", name, creator:{ _type:"reference",_ref:user_info.user_id }, admin:{ _type:"reference",_ref:user_info.user_id },members:[{ _type:"reference",_ref:member._id }],desciprtion,privacy,password };
