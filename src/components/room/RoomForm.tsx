...
export default function RoomForm({ isEditState }: RoomFormProps) {
    ...
    const { updateRoom, getRoomById } = useRoom(initRoom);
                    ...
                    <div className="w-full h-full flex flex-col gap-10">
                        ...
                        <div className="w-full grid grid-cols-3 gap-8">
                            <div className="w-full flex flex-col col-span-2 gap-4">
                                ...
                                <button onClick={isEditState ? updateRoom : createRoomHandler} className="w-full py-2 rounded-full text-gray-50 bg-primary-color">{isEditState ? "Update" : "Create new room"}</button>
                            </div>
