    ...
    return(
        <div className="w-full flex flex-col items-center font-mono py-20">
            <div className="w-2/3 flex flex-col items-center">
                ...
                <div className="w-11/12 flex flex-col items-center bg-gray-700 rounded-lg py-4">
                    {
...
function Question({ question }){
    ...
    return(
        <div className="w-11/12 flex flex-col items-center bg-gray-800 rounded-lg my-1">
            ...
            <div className={"w-full px-8 py-2 text-white text-sm bg-gray-900 rounded-b-lg"+ (is_open ? "" : " hidden")}>{question.answer}</div>
        </div>
